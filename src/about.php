    ...
    <div class="container">
        <div class="row g-5 align-items-center">
            ...
            <div class="col-lg-6">
                ...
                <p class="mb-4">At Foodzy, we believe in more than just cooking; we believe in creating culinary adventures that tantalize your taste buds and transport you to realms of flavor you never knew existed.</p>
                <p class="mb-4">Our chefs aren't just chefs; they're culinary wizards, conjuring up dishes that dance on your palate and leave you spellbound. Each ingredient is carefully selected, each dish meticulously crafted, to ensure every bite is a revelation.</p>
                <p class="mb-4">Whether you're craving comfort food that hugs your soul or daring delicacies that challenge your senses, Foodzy is your portal to gastronomic nirvana. So come, embark on a journey with us, and let your taste buds discover the path less traveled.</p>
                <p class="mb-4">But Foodzy isn't just about the food; it's about the experience. From the moment you step through our doors, you're greeted with warmth and hospitality that make you feel like family. Our attentive staff and inviting ambiance ensure that every visit is an occasion to remember.</p>
                ...
                <a class="btn btn-primary py-3 px-5 mt-2" href="menu.php">Embark Now</a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container">
        ...
        <div class="row g-4">
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="team-item text-center rounded overflow-hidden">
                    <div class="rounded-circle overflow-hidden m-4">
                        <img class="img-fluid" src="assets/img/chef-1.jpg" alt="">
                    </div>
            ...
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="team-item text-center rounded overflow-hidden">
                    <div class="rounded-circle overflow-hidden m-4">
                        <img class="img-fluid" src="assets/img/chef-2.jpg" alt="">
                    </div>
            ...
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="team-item text-center rounded overflow-hidden">
                    <div class="rounded-circle overflow-hidden m-4">
                        <img class="img-fluid" src="assets/img/chef-3.jpg" alt="">
                    </div>
