...
<head>
    ...
    <!-- Favicon -->
	<link href="img/bill/favicon.ico" rel="icon">
	<link rel="apple-touch-icon" sizes="180x180" href="img/bill/apple-touch-icon.png">
	<link rel="icon" type="image/png" sizes="32x32" href="img/bill/favicon-32x32.png">
	<link rel="icon" type="image/png" sizes="16x16" href="img/bill/favicon-16x16.png">
	<link rel="manifest" href="img/bill/site.webmanifest">
