...
<?php $feedback_query = pg_query($conn, "SELECT * FROM feedback");?>
                ...
                <?php while ($row = pg_fetch_assoc($feedback_query)) { ?>
                    <div class="testimonial-item bg-transparent border rounded p-4">
                        ...
                        <div class="d-flex align-items-center">
                            <img class="img-fluid flex-shrink-0 rounded-circle" src=<?php echo $row['picture']; ?> style="width: 50px; height: 50px;">
                            <div class="ps-3">
