...
<head>
    ...
    <!-- Favicon -->
	<link href="assets/img/bill/favicon.ico" rel="icon">
	<link rel="apple-touch-icon" sizes="180x180" href="assets/img/bill/apple-touch-icon.png">
	<link rel="icon" type="image/png" sizes="32x32" href="assets/img/bill/favicon-32x32.png">
	<link rel="icon" type="image/png" sizes="16x16" href="assets/img/bill/favicon-16x16.png">
	<link rel="manifest" href="assets/img/bill/site.webmanifest">
...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <!-- Checkout Start -->
        <button class="btn btn-primary w-100 py-3" type="submit">View Orders</button>
                ...
                <div class="col-md-6 bg-dark d-flex align-items-center">
                    <div class="p-5 wow fadeInUp" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
                        <div class="text-center">
                            <h5 class="section-title ff-secondary text-primary fw-normal">Checkout</h5>
                        </div>
                        <h1 class="text-white mb-4 text-center">Your Order</h1>
                        <div class="row g-3">
                            <!-- Placeholders for bill number and user ID in the same row -->
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-6 d-flex justify-content-start">
                                    <div class="placeholder">
                                        <div class="placeholder-title">Bill Number</div>
                                        <div class="placeholder-content" id="billNo">$(billNo)</div>
                                    </div>
                                </div>
                                <div class="col-6 d-flex justify-content-end">
                                    <div class="placeholder">
                                        <div class="placeholder-title">User ID</div>
                                        <div class="placeholder-content" id="userId">$(userId)</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <!-- Placeholder for total quantity -->
                            <div class="col-md-6">
                                <div class="placeholder">
                                    <div class="placeholder-title">Total Quantity</div>
                                    <div class="placeholder-content" id="totalQuantity">3</div>
                                </div>
                            </div>
                            <!-- Placeholder for total price -->
                            <div class="col-md-6">
                                <div class="placeholder">
                                    <div class="placeholder-title">Total Price</div>
                                    <div class="placeholder-content" id="totalPrice">$30</div>
                                </div>
                            </div>
                            <div class="col-12">
